...
- **`assets/` is entirely gitignored** — a fresh clone must run the pipeline scripts (`scrapper.js`, `imagescrapper.js`, `iconscrapper.js`, `schooliconscrapper.js`, then `imagemap.js`) to populate images.
